...
/**
 * Created by iqosjay@gmail.com on 2019/1/25.
 */
...
//        ALL_HINT_MAP.put(DecodeHintType.PURE_BARCODE, Boolean.TRUE);
     ...
     *
     * @param uri 要解析的二维码图片uri
     * @return 返回二维码图片里的内容 或 null
     */
    public static String syncDecodeQRCode(Context ctx, Uri uri) {
        return syncDecodeQRCode(getRealFilePath(ctx, uri));
    }
